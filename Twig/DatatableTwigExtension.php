...
namespace Olix\DatatablesBootstrapBundle\Twig;

use Sg\DatatablesBundle\Twig\DatatableTwigExtension as BaseDatatableTwigExtension;
 ...
 */
class DatatableTwigExtension extends BaseDatatableTwigExtension
{
    ...
    {
        //return $twig->render('OlixDatatablesBootstrapBundle::datatable_html.html.twig', $this->getOptions($datatable));
